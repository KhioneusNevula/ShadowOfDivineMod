 ...
 */
public interface IMindsEye {

	public static final ResourceLocation CAPABILITY_PATH = ModUtils.path("minds_eye");

	public static final Capability<IMindsEye> CAPABILITY = CapabilityManager.get(new CapabilityToken<>() {
	});

	public static IMindsEye get(ICapabilityProvider provider) {
