...
public interface IImpression {
	...
	/**
	 * Activate this impression's effect, if possible. Remember: inputs might be
	 * empty.
	 * 
	 * @param level
	 * @param activator
	 ...
	 * @return
	 */
	public default List<ImpressionType<?>> requireInputs() {
		return List.of();
	}
	...
	/**
	 * If this impression relies on periodically updating the client when its
	 * information changes, return true if this impression should update the client
	 * 
	 * @param level
	 * @param thinker
	 * @param state
	 ...
	 * @return
	 */
	public default boolean shouldServerUpdateClientNow(ServerLevel level, LivingEntity thinker, MentalState state,
			ImpressionTimetracker instance) {
		return false;
	}

	/**
	 * What to do when an update is received from server
	 * 
	 * @param graphics
	 * @param index
	 * @param state
	 * @param instance
	 */
	public default void onReceiveUpdateFromServer(MentalState state, ImpressionTimetracker instance) {
	 ...
	 * @return
	 */
	public default void runServerTick(ServerLevel level, LivingEntity thinker, MentalState mentalState,
