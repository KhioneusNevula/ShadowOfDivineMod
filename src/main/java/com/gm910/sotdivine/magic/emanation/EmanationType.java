...
import com.gm910.sotdivine.magic.emanation.types.GiveEffectEmanation;
import com.gm910.sotdivine.magic.emanation.types.ParticleEmanation;
import com.gm910.sotdivine.magic.emanation.types.combined.CombinedEmanation;
import com.gm910.sotdivine.magic.emanation.types.spawn.SpawnEmanation;
...
public class EmanationType<T extends IEmanation> {
	...
	public static <T extends IEmanation> RegistryObject<EmanationType<T>> register(String id, Codec<T> codec) {
		LogUtils.getLogger().debug("Registering emanation type " + id + " to registry " + SOTDMod.EMANATION_TYPES);
