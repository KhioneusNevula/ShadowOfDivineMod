...
public class BannerPatternComponentMatcher implements IComponentMatcherProvider<BannerPatternLayers> {
	...
	public Component translate() {
		...
		return TextUtils.transPrefix(
				"sotd.genre.provider.banner.layers" + (position == Position.ANYWHERE ? "" : "_position")
						+ (sequential ? "_ordering" : ""),
				layers, TextUtils.transPrefix(ordering),
				TextUtils.transPrefix("sotd.genre.provider.banner." + position.toString().toLowerCase()));
	}
