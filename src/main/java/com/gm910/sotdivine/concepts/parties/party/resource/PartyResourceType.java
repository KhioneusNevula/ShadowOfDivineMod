package com.gm910.sotdivine.concepts.parties.party.resource;
...
import com.gm910.sotdivine.concepts.parties.party.resource.type.EntityResource;
import com.gm910.sotdivine.concepts.parties.party.resource.type.IDResource;
import com.gm910.sotdivine.concepts.parties.party.resource.type.IDimensionResource;
import com.gm910.sotdivine.concepts.parties.party.resource.type.IEntityResource;
import com.gm910.sotdivine.concepts.parties.party.resource.type.IIDResource;
...
import com.gm910.sotdivine.concepts.parties.party.resource.type.SoulResource;
...
public class PartyResourceType<T extends IPartyResource> {
	...
	private static Codec<IPartyResource> O_CODEC = null;
	 ...
	 * @return
	 */
	public static Codec<IPartyResource> resourceCodec() {
		if (O_CODEC == null) {

			O_CODEC = Codec.lazyInitialized(() -> REGISTRY.get().getCodec().dispatch("resourceType",
					IPartyResource::resourceType, PartyResourceType::codec));
		}
		return O_CODEC;
	}
	...
	public static <T extends IPartyResource> RegistryObject<PartyResourceType<T>> register(String id, boolean fungible,
		...
		LogUtils.getLogger().debug("Registering resource " + id + " to registry " + SOTDMod.PARTY_RESOURCE_TYPES);
