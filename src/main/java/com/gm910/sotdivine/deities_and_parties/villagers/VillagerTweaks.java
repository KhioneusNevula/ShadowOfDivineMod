package com.gm910.sotdivine.deities_and_parties.villagers;
...
import com.gm910.sotdivine.deities_and_parties.villagers.ModBrainElements.SensorTypes;
...
public class VillagerTweaks {
	...
	/**
	 * Tries to check who the local leader is and match memories to that leader
	 * 
	 * @param system
	 * @param villager
	 * @param level
